...
export async function POST(req: NextRequest) {
  try {
    ...
    await resend.emails.send({
      ...
      to: normalizedEmail,
      subject: "Réinitialisation de ton mot de passe — myloopclub",
      html: `
        <!DOCTYPE html>
        <html lang="fr">
          <head>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
                    <tr>
                      <td style="padding-bottom:32px;text-align:center;">
                        <span style="font-size:28px;font-weight:900;color:#0e59c3;text-decoration:none;">myloopclub</span>
                      </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td style="padding-top:24px;text-align:center;">
                        <p style="margin:0;font-size:12px;color:rgba(0,0,0,0.3);">
                          © ${new Date().getFullYear()} myloopclub. Tous droits réservés.
                        </p>
                      </td>
                    </tr>
                  </table>
